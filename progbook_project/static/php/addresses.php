...
// <!-- this api used return system available addresses  -->
 ...
 try
{
    ...
    elseif ($_SERVER['REQUEST_METHOD'] === 'GET')
    {
        ...
        try
        {
            ...
            $sql = "select city.id ID , concat( country.name , concat( ' - ' , city.name ) )  as NAME from country 
            right join city on country_id = country.id
